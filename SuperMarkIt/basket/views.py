...
def update_basket(request, slug):
    ...
    for item in basket.basketitem_set.all():
        ...
        product_total_snapdeal = float(item.product.price_snapdeal) * item.quantity
        start_total_flipkart += product_total_flipkart
        start_total_amazon += product_total_amazon
        start_total_snapdeal += product_total_snapdeal
    ...
    basket.total_snapdeal = start_total_snapdeal
